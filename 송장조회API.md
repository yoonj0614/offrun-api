...
```bash
curl -X GET "https://kicoebiz.net/api/order/getInvcInfo?mid=26&oid=7612" \
...
```
https://kicoebiz.net/api/order/getInvcInfo?mid=26&oid=7612
```
...
| 버전 | 날짜 | 작성자 | 변경 내용 |
|------|------|--------|-----------|
| v1.0.0 | 2026-04-20 | `윤준` | 최초 작성 - 송장 조회 API 추가 |
